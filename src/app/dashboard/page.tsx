            ...
            <div className="main-content">
                ...
                <div className="budget-grid-container">
                    <div className="budget-grid">
                        ...
                        <BudgetCardWithProgressBar category="Groceries" budget={300} spent={150} icon="/groceries.png" />
                        ...
                        <BudgetCardWithProgressBar category="Traveling" budget={300} spent={150} icon="/traveling.png" />
