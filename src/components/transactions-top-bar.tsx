...
function TransactionsTopBar() {
    ...
    const { categories, addTransaction, selectedMonth, prevMonth, nextMonth } = useBudgetStore(
        ({ categories, addTransaction, selectedMonth, prevMonth, nextMonth }) => ({
            categories,
            addTransaction,
            selectedMonth,
            prevMonth,
        ...
        <div className="flex gap-2 mt-4 items-center">
            ...
            <div className="ml-auto flex gap-2">
                <Drawer>
                    ...
                    <DrawerContent className="bg-[#FAF8F5] flex justify-center items-center">
                        <DrawerHeader className="max-w-md w-full ">
                            <DrawerTitle className="text-2xl text-center"> Add Income</DrawerTitle>
                        </DrawerHeader>
                        <DrawerFooter className="max-w-md w-full">
                            ...
                            <DrawerClose>
                                <button
                                    onClick={() => {
                                        addTransaction({ category, amount, date, name, type: "Income" });
                                        setAmount(0);
                                        setName("");
                                        setDate(new Date());
                                        setCategory("");
                ...
                <Drawer>
                    ...
                    <DrawerContent className="bg-[#FAF8F5] flex justify-center items-center">
                        <DrawerHeader className="max-w-md w-full ">
                            <DrawerTitle className="text-2xl text-center"> Add Expense</DrawerTitle>
                        </DrawerHeader>
                        <DrawerFooter className="max-w-md w-full">
                            <InputField label="Name" placeholder="" value={name} setValue={setName} />
                            <InputField label="Amount" placeholder="$0.00" value={amount} setValue={setAmount} />
                            ...
                            <DrawerClose>
                                <button
                                    onClick={() => {
                                        addTransaction({ category, amount, date, name, type: "Expense" });
                                        setAmount(0);
                                        setName("");
                                        setDate(new Date());
                                        setCategory("");
