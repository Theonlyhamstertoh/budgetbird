...
function TransactionsTopBar({ selectedMonth, prevMonth, nextMonth }: TransactionsTopBarProps) {
    ...
    const { categories, addTransaction } = useBudgetStore(({ categories, addTransaction }) => ({
        categories,
        addTransaction,
        // selectedMonth,
        // prevMonth,
    ...
    return (
        <div className="flex gap-2 mt-4 items-center">
            <Button
                size={"icon"}
                variant={"ghost"}
                className="border-2 bg-white  border-zinc-200/70 rounded-lg flex items-center"
